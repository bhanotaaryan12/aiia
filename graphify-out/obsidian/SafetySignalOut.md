---
source_file: "backend/app/schemas/pharmacovigilance.py"
type: "code"
...
- [[Config_13]] - `contains` [EXTRACTED]
- [[schemaspharmacovigilance.py]] - `contains` [EXTRACTED]
- [[v1pharmacovigilance.py]] - `imports` [EXTRACTED]
